...
trait TensorNumeric[@specialized(Float, Double) T] extends Serializable {
  ...
  def arraycopy(src: Array[T], srcPos: Int, dest: Array[T], destPos: Int, length: Int): Unit = {}
...
object TensorNumeric {
  ...
  implicit object NumericFloat extends TensorNumeric[Float] {
    ...
    override def fromType[@specialized(Float, Double, Int) K](k: K)(implicit
        c: ConvertableFrom[K]
    ): Float = c.toFloat(k)

    override def toType[@specialized(Float, Double, Int) K](t: Float)(implicit
        c: ConvertableTo[K]
    ): K = c.fromFloat(t)
    ...
    override def gemv(
      ...
      require(MKL.isMKLLoaded, "mkl hasn't been loaded")
      MKL.vsgemv(trans, m, n, alpha, a, aoffset, lda, x, xOffset, incx, beta, y, yOffset, incy)
    }
    ...
    override def ger(
      ...
      require(MKL.isMKLLoaded, "mkl hasn't been loaded")
      MKL.vsger(m, n, alpha, x, _x_offset, incx, y, _y_offset, incy, a, _a_offset, lda)
    }
  ...
  implicit object NumericDouble extends TensorNumeric[Double] {
    ...
    override def toType[@specialized(Float, Double, Int) K](t: Double)(implicit
        c: ConvertableTo[K]
    ): K = c.fromDouble(t)
    ...
    override def gemv(
      ...
      require(MKL.isMKLLoaded, "mkl hasn't been loaded")
      MKL.vdgemv(trans, m, n, alpha, a, aoffset, lda, x, xOffset, incx, beta, y, yOffset, incy)
    }
    ...
    override def ger(
      ...
      require(MKL.isMKLLoaded, "mkl hasn't been loaded")
      MKL.vdger(m, n, alpha, x, _x_offset, incx, y, _y_offset, incy, a, _a_offset, lda)
    }
  ...
  implicit object NumericLong extends TensorNumeric[Long] {
    ...
    override def exp(x: Long): Long = java.lang.Math.exp(x.toDouble).toLong

    override def log(x: Long): Long = java.lang.Math.log(x.toDouble).toLong
